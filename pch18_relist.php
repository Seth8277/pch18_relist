...
function pch18_relist_setting()
{
    ...
    <td>自动刷新贴吧列表</td>
    <td>
        <input type="radio" name="pch18_relist_enable" value="1" <?php if (option::uget('pch18_relist_enable') == 1) {
            echo 'checked';
        } ?> > 是&nbsp;
        <input type="radio" name="pch18_relist_enable" value="0" <?php if (option::uget('pch18_relist_enable') != 1) {
            echo 'checked';
        } ?> > 否
    </td>
...
{
    echo '<li ';
    if (isset($_GET['plug']) && $_GET['plug'] == 'pch18_relist') {
        echo 'class="active"';
    }
